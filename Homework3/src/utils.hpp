 ...
 * @param recursive: whether to check the subfolders
 */
void checkFolder(cv::String input_dir, std::vector<cv::String> &filenames, bool recursive = false);

/*
 * Check if the input file exists.
 * @param input_file: the input file
 */
void checkFile(cv::String input_file);
 ...
 */
cv::Point2i getRectCenter(cv::Rect rect); 
